...
During my time at Badgley Phelps, I observed that the firm’s data analysis was primarily performed using Excel—a powerful tool but one that lacked the sophistication of advanced data science techniques—alongside other resources such as Bloomberg, JPMorgan, Money Guide Pro for income projections, and Tamarac for real-time data integrity. Recognizing this gap, I developed a model to leverage machine learning for stock price prediction. The goal was to improve the performance of fundamental investment stratagies, ultimately bridging finance and data science.
